...
const Theaters = () => {
  ...
  const { isLoading, serverRequest, apiKey, responseData, fetchError } =
    UseApiFetch();
  ...
  const fnResponseForTheaterDetails = () => {
    setReRender(!reRender);
    setTheatersData(responseData);
  };
   ...
   useEffect(() => {
    ...
    }, [apiKey,fetchError,isLoading,responseData]);
